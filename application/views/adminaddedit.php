...
<div class="form-group">
                    <label>User_id</label>
                    <input type="text" class="form-control" name="user_id" value="<?php echo !empty($member['user_id'])?$member['user_id']:''; ?>" >
                    <?php echo form_error('user_id','<div class="invalid-user_id">','</div>'); ?>
                </div>
